...
var _anneFly$score_counter$Main$lastChange = function (value) {
...
var _anneFly$score_counter$Main$score = F2(
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _anneFly$score_counter$Main$lastChange(player.lastChange),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _anneFly$score_counter$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _anneFly$score_counter$Main$initPlayer = {score: 20, lastChange: 0};
var _anneFly$score_counter$Main$init = {
	ctor: '_Tuple2',
...
var _anneFly$score_counter$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Add':
				if (_p0._1.ctor === 'P1') {
					...
					return {
						ctor: '_Tuple2',
						_0: m,
						_1: _anneFly$score_counter$Main$playSound(sound)
					};
				} else {
					var _p2 = _p0._0;
					var sound = model.sound ? 'on' : 'off';
...
var _anneFly$score_counter$Main$Player = F2(
	function (a, b) {
		return {score: a, lastChange: b};
	});
var _anneFly$score_counter$Main$Model = F5(
	function (a, b, c, d, e) {
		return {p1: a, p2: b, fullscreen: c, sound: d, settingsView: e};
	});
var _anneFly$score_counter$Main$P2 = {ctor: 'P2'};
var _anneFly$score_counter$Main$P1 = {ctor: 'P1'};
var _anneFly$score_counter$Main$Noop = {ctor: 'Noop'};
var _anneFly$score_counter$Main$onDummySubmit = A3(
	_elm_lang$html$Html_Events$onWithOptions,
	'submit',
	{stopPropagation: true, preventDefault: true},
	_elm_lang$core$Json_Decode$succeed(_anneFly$score_counter$Main$Noop));
var _anneFly$score_counter$Main$SetScoreP2 = function (a) {
	return {ctor: 'SetScoreP2', _0: a};
};
var _anneFly$score_counter$Main$SetScoreP1 = function (a) {
	return {ctor: 'SetScoreP1', _0: a};
};
var _anneFly$score_counter$Main$SettingsView = function (a) {
	return {ctor: 'SettingsView', _0: a};
};
var _anneFly$score_counter$Main$settingsButton = function (model) {
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_anneFly$score_counter$Main$SettingsView(true)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _anneFly$score_counter$Main$settingsView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_0: A2(
				_elm_lang$html$Html$span,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_anneFly$score_counter$Main$SettingsView(false)),
						_1: {ctor: '[]'}
					}
				},
				{
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$form,
					{
						...
						_1: {
							ctor: '::',
							_0: _anneFly$score_counter$Main$onDummySubmit,
							_1: {ctor: '[]'}
						}
					},
					{
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_anneFly$score_counter$Main$SetScoreP1),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
									...
									_1: {
										...
										_0: A2(
											_elm_lang$html$Html$input,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_anneFly$score_counter$Main$SetScoreP2),
													_1: {ctor: '[]'}
												}
											},
											{ctor: '[]'}),
...
var _anneFly$score_counter$Main$SetSound = function (a) {
	...
	if (_p6 === false) {
		return A2(
			_elm_lang$html$Html$a,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_anneFly$score_counter$Main$SetSound(true)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
		...
		return A2(
			_elm_lang$html$Html$a,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_anneFly$score_counter$Main$SetSound(false)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _anneFly$score_counter$Main$FullscreenMode = function (a) {
...
var _anneFly$score_counter$Main$Add = F2(
	function (a, b) {
		return {ctor: 'Add', _0: a, _1: b};
	});
var _anneFly$score_counter$Main$counter = F2(
	function (playerPosition, value) {
		var addval = F2(
			function (n, direction) {
				return _elm_lang$core$Native_Utils.eq(direction, 'plus') ? n : (n * -1);
			});
		var player = _elm_lang$core$Native_Utils.eq(playerPosition, 'left') ? _anneFly$score_counter$Main$P1 : _anneFly$score_counter$Main$P2;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				...
				_0: A2(
					_elm_lang$html$Html$button,
					{
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Events$onClick(
								A2(
									_anneFly$score_counter$Main$Add,
...
var _anneFly$score_counter$Main$playerCol = F3(
	function (model, position, className) {
		return A2(
			...
			{
				ctor: '::',
				_0: A2(_anneFly$score_counter$Main$counter, position, 1),
				_1: {
					ctor: '::',
					_0: A2(_anneFly$score_counter$Main$score, model, position),
					_1: {
						ctor: '::',
						_0: A2(_anneFly$score_counter$Main$counter, position, 5),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _anneFly$score_counter$Main$mainView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: A3(_anneFly$score_counter$Main$playerCol, model, 'left', 'sc-p-left'),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					...
					{
						ctor: '::',
						_0: _anneFly$score_counter$Main$soundButton(model),
						_1: {
							ctor: '::',
							_0: _anneFly$score_counter$Main$settingsButton(model),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$span,
								...
								_1: {
									ctor: '::',
									_0: _anneFly$score_counter$Main$fullScreenButton(model),
									_1: {ctor: '[]'}
								}
							}
						}
				...
				_1: {
					ctor: '::',
					_0: A3(_anneFly$score_counter$Main$playerCol, model, 'right', 'sc-p-right'),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _anneFly$score_counter$Main$view = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.settingsView, true) ? A2(
		...
		{
			ctor: '::',
			_0: _anneFly$score_counter$Main$settingsView(model),
			_1: {ctor: '[]'}
		}) : A2(
		_elm_lang$html$Html$div,
		{
		...
		{
			ctor: '::',
			_0: _anneFly$score_counter$Main$mainView(model),
			_1: {ctor: '[]'}
		});
};
var _anneFly$score_counter$Main$main = _elm_lang$html$Html$program(
	{init: _anneFly$score_counter$Main$init, view: _anneFly$score_counter$Main$view, update: _anneFly$score_counter$Main$update, subscriptions: _anneFly$score_counter$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _anneFly$score_counter$Main$main !== 'undefined') {
    _anneFly$score_counter$Main$main(Elm['Main'], 'Main', undefined);
}
